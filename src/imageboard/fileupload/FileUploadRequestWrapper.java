...
// FileUpload API 를 사용하는 HttpServletRequestWrapper 클래스로서 HttpServletRequest 에 기반한 API 를 사용하기 위한 래퍼
public class FileUploadRequestWrapper extends HttpServletRequestWrapper{
	...
	public Enumeration getParameterNames() {
		...
		}else return super.getParameterNames();
	}
	
	public Map getParameterMap() {
		if(multipart)	return parameterMap;
	...
	public static boolean hasWrapper(HttpServletRequest request) {
		if(FileUploadRequestWrapper.getFrom(request) == null)	return false;
		else													return true;
	}
