...
function checkIt(){
	...
	if(userunpud.pass.value != userinput.passwd2.value){
		alert("비밀번호가 같아요!");
		return false;
	}
		...
		<div id = "body">
			<table width="500px;">
				...
				<tr>
					...
					<tr>
						<th>우편번호</th>
						<td><input type="text" name="zipcode" /><input type="button" value="우편번호 검색" class="inputBtn" onclick="javascript:zipCheck();" />
							<span>우편번호를 입력하세요.</span>
						</td>
					</tr>
					<tr>
						<th>주소</th>
						<td><input type="text" name="address" class="w380" />
